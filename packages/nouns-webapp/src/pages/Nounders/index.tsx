  ...
  return (
    <Section fullWidth={true} className={classes.noundersPage}>
      <Col lg={{ span: 6, offset: 3 }}>
        <h2 style={{ marginBottom: '2rem' }}>The Founders</h2>
        ...
        <p style={{ textAlign: 'justify' }}>
          All Noun auction proceeds are sent to the Noname DAO. For this reason, we, the project's
          founders have chosen to compensate ourselves with Nouns. Every 10th noun for
          the first 5 years of the project will be sent to our multisig (5/10), where it will be
          vested and distributed to individual Founders.
        </p>
        <p style={{ textAlign: 'justify' }}>
          The Founders reward is intended as compensation for our pre and post-launch contributions
          to the project, and to help us participate meaningfully in governance as the project
          matures. Since there are 10 Founders, after 5 years each Nounder could receive up to 1% of
          the Noun supply.
        </p>
      </Col>
    </Section>
