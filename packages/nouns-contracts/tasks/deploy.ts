...
task('deploy', 'Deploys NFTDescriptor, NounsDescriptor, NounsSeeder, and NounsToken')
  ...
  .addParam('weth', 'The WETH contract address', '0x0d500b1d8e8ef31e21c99d1db9a6444d3adf1270', types.string)
  .addOptionalParam('auctionTimeBuffer', 'The auction time buffer (seconds)', 5 * 60, types.int)
  .addOptionalParam('auctionReservePrice', 'The auction reserve price (wei)', 500000000, types.int)
  .addOptionalParam(
  ...
  .addOptionalParam('auctionDuration', 'The auction duration (seconds)', 60 * 60 * 2, types.int) // Default: 24 hours
  .addOptionalParam('timelockDelay', 'The timelock delay (seconds)', 60 * 60 * 24 * 2, types.int) // Default: 2 days
  .addOptionalParam('votingPeriod', 'The voting period (blocks)', 4 * 60 * 24 * 4, types.int) // Default: 3 days
  .addOptionalParam('votingDelay', 'The voting delay (blocks)', 4 * 60 * 24 * 2, types.int) // Default: 1 block
